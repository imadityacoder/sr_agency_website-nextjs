            ...
            <div className="rounded-[25px] border border-white/10 bg-white/[0.055] p-4 backdrop-blur-2xl sm:rounded-[31px] sm:p-7">
              <form className="grid gap-4" onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  className="magnetic mt-2 inline-flex min-h-13 items-center justify-center gap-2 rounded-full bg-white px-6 text-sm font-bold !text-black shadow-[0_0_40px_rgba(93,244,255,0.18)] disabled:cursor-not-allowed disabled:opacity-70"
                >
              ...
              <div className="mt-5 rounded-[24px] border border-white/10 bg-black/24 p-4">
                <div className="mb-3 flex items-center justify-between">
                  <span className="text-sm font-semibold text-white/82">Preferred call time</span>
                    ...
                    <button
                      ...
                      className={`rounded-2xl border px-3 py-3 text-sm transition ${
                        selectedSlot === slot
                          ...
                          : "border-white/10 bg-white/[0.045] text-white/72 hover:border-cyan-200/40 hover:text-white"
                      }`}
                    >
                      {slot}
                    </button>
